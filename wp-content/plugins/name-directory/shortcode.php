...
function name_directory_show_directory($attributes)
{
    ...
    foreach($index_letters as $index_letter)
    {
        ...
        echo ' <a class="name_directory_startswith name_directory_total' . $extra_classes . '" href="' . $letter_url . urlencode($index_letter) . $jump_location . '">' . strtoupper($index_letter) . '</a> ';
    }
