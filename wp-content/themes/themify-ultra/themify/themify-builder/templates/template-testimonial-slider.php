        ...
        <ul class="themify_builder_slider" 
            ...
            <?php if (!empty($content['title_testimonial'])): ?>
                            ...
                            <?php if (!empty($content['content_testimonial'])): ?>
                                <div class="testimonial-entry-content"><?php echo $content['content_testimonial'] ?></div>
                            <?php endif; ?>
                            <?php if ($layout_testimonial === 'image-bottom' && !empty($image)): ?>
                ...
                <?php if (!empty($content['person_position_testimonial'])): ?>
                                        ...
                                        <?php if (!empty($content['company_testimonial'])): ?>
                                            ...
                                            <?php if (!empty($content['company_website_testimonial'])): ?>
                                                    <a href="<?php $content['company_website_testimonial'] ?>"><?php echo $content['company_testimonial'] ?></a>
                                                <?php else: ?>
