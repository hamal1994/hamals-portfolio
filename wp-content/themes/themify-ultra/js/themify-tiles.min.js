...
c.grid.isDirty=!0;c.grid.redraw(c.opts.animate_template,c.onresize,c);k&&(LayoutAndFilter.filterActive=k);setClasses(h,e)}}).data("themify_tiles",this);a(window).on("debouncedresize",function(a){a.isTrigger||(c.grid.template=c.get_template(),c.grid.isDirty=!0,c.grid.resize(),c.addClass("tiles_resing"),c.grid.redraw(b.animate_resize,c.onresize,c))})}})})(jQuery);
