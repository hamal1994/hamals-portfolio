...
$sidebars_widgets = array (
  ...
  'footer-widget-3' => 
  array (
    0 => 'themify-social-links-1016',
  ),
  'footer-widget-4' => 
  array (
    0 => 'mc4wp_form_widget-1017',
  ),
); 
update_option( "sidebars_widgets", $sidebars_widgets );

$menu_locations = array();
$menu = get_terms( "nav_menu", array( "slug" => "game-menu" ) );
